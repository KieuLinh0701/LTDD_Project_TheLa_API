...
import vn.iotstar.TheLaApp.repository.ProductImageRepository;
...
import vn.iotstar.TheLaApp.service.IProductImageService;
...
public class ProductImageService implements IProductImageService{
	...
	public List<ProductImageDto> getProductImagesByProductId(Long productId) {
		List<ProductImage> list = repository.getProductImagesByProductId(productId);
		return convert.convertToListProductImageDto(list);
	}
}
